        ...
        try:
            ...
            if len(session_key_b64) == 44:
                try:
                    ...
                    return render_template('index_receiver.html', sent_emails=get_sent_emails(), decode_status='Failed', decode_message=f'Key AES không đúng hoặc lỗi giải mã: {str(e)}'), 400
            else:
